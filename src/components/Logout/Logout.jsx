    ...
    <>
      ...
      <div>
        ...
        <ul className="logout-options">
          <li className="logout-yes-li">
            <button className="logout-btn" onClick={handleClickYes}>
              Sí
            </button>
          </li>
          <li className="logout-no-li">
            <button className="logout-btn" onClick={handleClickNo}>
              No
            </button>
          </li>
        </ul>
